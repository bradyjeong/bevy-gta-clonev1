use bevy::prelude::*;
use game_core::components::{SuperCar, ActiveEntity, Car};
            ...
            if *current_state.get() == GameState::Driving {
                ...
                if let Ok(mut info_text) = info_query.single_mut() {
                    let mode = match supercar.driving_mode {
                        game_core::components::DrivingMode::Comfort => "COMFORT",
                        game_core::components::DrivingMode::Sport => "SPORT",
                        game_core::components::DrivingMode::Track => "TRACK",
                        game_core::components::DrivingMode::Custom => "CUSTOM",
                    };

...
fn spawn_unified_intersection_entity(
    ...
    if let Some(intersection_mesh) = generate_intersection_mesh() {
        commands.spawn((
...
fn spawn_unified_building(
    ...
    match factory.spawn_entity_consolidated(commands, meshes, materials, ContentType::Building, position, None, &[], current_time) {
        Ok(Some(entity)) => {
            // Add chunk-specific components to maintain compatibility
            commands.entity(entity).insert((
                UnifiedChunkEntity {
                    coord: chunk_coord,
                    layer: ContentLayer::Buildings as u32,
                },
            ));
            entity
        }
...
fn generate_vehicles_for_chunk(
    ...
    // Mark vehicles as generated - SKIP: field not available in current ChunkData
}
...
fn spawn_unified_vehicle(
    ...
    match factory.spawn_entity_consolidated(commands, meshes, materials, ContentType::Vehicle, position, None, &[], current_time) {
        Ok(Some(entity)) => {
            // Add chunk-specific components to maintain compatibility
            commands.entity(entity).insert((
                UnifiedChunkEntity {
                    coord: chunk_coord,
                    layer: ContentLayer::Vehicles as u32,
                },
            ));
            entity
        }
...
fn generate_vegetation_for_chunk(
    ...
    // Mark vegetation as generated - SKIP: field not available in current ChunkData
}
...
fn spawn_unified_tree(
    ...
    match factory.spawn_entity_consolidated(commands, meshes, materials, ContentType::Tree, position, None, &[], current_time) {
        Ok(Some(entity)) => {
            // Add chunk-specific components to maintain compatibility
            commands.entity(entity).insert((
                UnifiedChunkEntity {
                    coord: chunk_coord,
                    layer: ContentLayer::Vegetation as u32,
                },
            ));
            entity
        }

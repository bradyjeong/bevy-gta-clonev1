...
impl ConfigService {
    ...
    #[must_use] pub fn get_config(&self) -> &GameConfig {
        &self.config
    }
...
impl PhysicsService {
    #[must_use] pub fn new(physics_config: PhysicsConfig) -> Self {
        Self { physics_config }
    }
    
    #[must_use] pub fn validate_position(&self, position: Vec3) -> Vec3 {
        Vec3::new(
    ...
    #[must_use] pub fn validate_velocity(&self, velocity: Vec3) -> Vec3 {
    ...
    #[must_use] pub fn validate_mass(&self, mass: f32) -> f32 {
        mass.clamp(self.physics_config.min_mass, self.physics_config.max_mass)
    }
    
    #[must_use] pub fn validate_collider_size(&self, size: Vec3) -> Vec3 {
        Vec3::new(
    ...
    #[must_use] pub fn get_collision_groups(&self) -> (bevy_rapier3d::prelude::Group, bevy_rapier3d::prelude::Group, bevy_rapier3d::prelude::Group) {
        (

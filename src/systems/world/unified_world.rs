...
// NOTE: World streaming systems removed - static generation is the current design
// If streaming is needed in the future, reintroduce under a "streaming" feature flag

...
use crate::systems::world::road_network::{
    IntersectionType, RoadIntersection, RoadSpline, RoadType,
};
use bevy::prelude::*;
...
pub fn generate_road_mesh_cached(
    ...
    if mesh_cache.road_meshes.len() < 500 {
        // Limit cache size
...
fn generate_cross_intersection_mesh(
    intersection: &RoadIntersection,
    _connected_roads: &[&RoadSpline],
) -> Mesh {
...
fn generate_t_intersection_mesh(
    intersection: &RoadIntersection,
    _connected_roads: &[&RoadSpline],
) -> Mesh {
...
fn generate_curved_intersection_mesh(
    intersection: &RoadIntersection,
    _connected_roads: &[&RoadSpline],
) -> Mesh {

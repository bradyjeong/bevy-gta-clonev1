...
pub fn npc_animation_system(
    ...
    mut head_query: Query<(&ChildOf, &mut Transform), (With<NPCHead>, Without<NPCTorso>, Without<NPCLeftArm>, Without<NPCRightArm>, Without<NPCLeftLeg>, Without<NPCRightLeg>, Without<NPCLeftFoot>, Without<NPCRightFoot>)>,
    mut torso_query: Query<(&ChildOf, &mut Transform), (With<NPCTorso>, Without<NPCHead>, Without<NPCLeftArm>, Without<NPCRightArm>, Without<NPCLeftLeg>, Without<NPCRightLeg>, Without<NPCLeftFoot>, Without<NPCRightFoot>)>,
    mut left_arm_query: Query<(&ChildOf, &mut Transform), (With<NPCLeftArm>, Without<NPCHead>, Without<NPCTorso>, Without<NPCRightArm>, Without<NPCLeftLeg>, Without<NPCRightLeg>, Without<NPCLeftFoot>, Without<NPCRightFoot>)>,
    mut right_arm_query: Query<(&ChildOf, &mut Transform), (With<NPCRightArm>, Without<NPCHead>, Without<NPCTorso>, Without<NPCLeftArm>, Without<NPCLeftLeg>, Without<NPCRightLeg>, Without<NPCLeftFoot>, Without<NPCRightFoot>)>,
    mut left_leg_query: Query<(&ChildOf, &mut Transform), (With<NPCLeftLeg>, Without<NPCHead>, Without<NPCTorso>, Without<NPCLeftArm>, Without<NPCRightArm>, Without<NPCRightLeg>, Without<NPCLeftFoot>, Without<NPCRightFoot>)>,
    mut right_leg_query: Query<(&ChildOf, &mut Transform), (With<NPCRightLeg>, Without<NPCHead>, Without<NPCTorso>, Without<NPCLeftArm>, Without<NPCRightArm>, Without<NPCLeftLeg>, Without<NPCLeftFoot>, Without<NPCRightFoot>)>,
    mut left_foot_query: Query<(&ChildOf, &mut Transform), (With<NPCLeftFoot>, Without<NPCHead>, Without<NPCTorso>, Without<NPCLeftArm>, Without<NPCRightArm>, Without<NPCLeftLeg>, Without<NPCRightLeg>, Without<NPCRightFoot>)>,
    mut right_foot_query: Query<(&ChildOf, &mut Transform), (With<NPCRightFoot>, Without<NPCHead>, Without<NPCTorso>, Without<NPCLeftArm>, Without<NPCRightArm>, Without<NPCLeftLeg>, Without<NPCRightLeg>, Without<NPCLeftFoot>)>,
) {

...
impl TransformFactory {
    ...
    pub fn at_ground_level(x: f32, z: f32, env: &WorldEnvConfig) -> Transform {
        Transform::from_xyz(x, env.land_elevation, z)
    }
    ...
    // VEHICLE POSITIONING
    pub fn vehicle_spawn(x: f32, z: f32, env: &WorldEnvConfig) -> Transform {
        Transform::from_xyz(x, env.land_elevation + 0.5, z)
    }
    ...
    // WORLD STRUCTURES
    pub fn lamp_post(x: f32, z: f32, env: &WorldEnvConfig) -> Transform {
        Transform::from_xyz(x, env.land_elevation, z)
    }
    ...
    pub fn tree_position(x: f32, z: f32, env: &WorldEnvConfig) -> Transform {
        Transform::from_xyz(x, env.land_elevation, z)
    }

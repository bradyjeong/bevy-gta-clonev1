...
const MAP_SIZE: f32 = 4000.0; // Total 4km x 4km world
...
impl Default for MapSystem {
    fn default() -> Self {
        Self {
            ...
            lod_distances: [300.0, 600.0, 1000.0], // LOD transition distances
        }
    }
}
...
fn spawn_chunk(
    ...
    let template = generate_chunk_template(coord);
...
fn generate_chunk_template(coord: IVec2) -> ChunkTemplate {
    use rand::Rng;
    ...
    for _ in 0..(building_density * 30.0) as usize {
        ...
        let (scale, height) = match building_type {
            BuildingType::Skyscraper => (Vec3::new(8.0, 15.0, 8.0), rng.gen_range(40.0..80.0)),
            BuildingType::Commercial => (Vec3::new(12.0, 8.0, 6.0), rng.gen_range(8.0..20.0)),
            BuildingType::Residential => (Vec3::new(6.0, 6.0, 8.0), rng.gen_range(6.0..15.0)),
            _ => (Vec3::new(4.0, 4.0, 4.0), rng.gen_range(3.0..8.0)),
        };
    ...
    for _ in 0..rng.gen_range(3..8) {
        vegetation.push(VegetationPatch {
            ...
            density: rng.gen_range(0.3..0.8),
            vegetation_type: if rng.gen_bool(0.6) { VegetationType::Trees } else { VegetationType::Bushes },
        });
    }
    ...
    if rng.gen_bool(0.1) {
        landmarks.push(LandmarkTemplate {
            ...
            landmark_type: match rng.gen_range(0..4) {

...
impl TransformFactory {
    ...
    pub fn road_segment_horizontal(x: f32, z: f32, segment_size: f32, road_width: f32) -> Transform {
        let safe_segment = segment_size.max(1.0).min(1000.0);
        Transform::from_xyz(safe_segment * 1.5, 0.1, road_width)
    }

    pub fn road_segment_vertical(x: f32, z: f32, segment_size: f32, road_width: f32) -> Transform {
        let safe_segment = segment_size.max(1.0).min(1000.0);
